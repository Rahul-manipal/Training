...
public class SyncDemo implements Runnable {
	...
	private synchronized void print(String name) { // synchronised method - locks current object by default
		...
		// try {
//			synchronized (this) {// this represents the object thread should acquire lock
//				
//			
//			System.out.println("[");
//			Thread.sleep(1000);
...
//			}
		try {
			synchronized (dummy) {// this represents the object that you want thread should acquire lock
